...
# Here are some of the best fantasy baseball experts and insiders to follow for up to date news
accounts = ['Rotoworld_BB','BaseballGuys', 'MikeGianella', 'KurkjianESPN','mlbtraderumors','CloserMonkey','closernews','PitcherList','DynastyGuru','TheSpokenKeats']
...
for account in accounts:
    ...
    for tweet in stream:
        ...
        verified.append(tweet.user.verified) # verified or not
...
df.to_csv("FantasyBaseball.csv", index = True, header = True)